...
tellraw @s ["\n",{"text":"--- FIA 金幣、道具選項 ---","bold":true},"\n","此處所有選項需要 /function 指令使用權限。","\n","\n",{"text":"[給予、更改或扣除 FIA 金幣]","bold":true,"color":"gold","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/give_fiacoin"},"hoverEvent":{"action":"show_text","contents":[{"text":"給予、更改或扣除自己、特定玩家或所有玩家特定數量的 FIA 金幣，需要 /function 指令使用權限。","color":"red"}]}}]

# 全部道具：停用
execute if score all_items value matches 0 run tellraw @s ["","全部道具 ",{"text":"[停用]","bold":true,"underlined":true,"color":"red"}," ",{"text":"[啟用]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/all_items_on"},"hoverEvent":{"action":"show_text","contents":[{"text":"啟用後，你將不須購買道具，即可適用所有道具；需要 /function 指令使用權限。","color":"red"}]}}]

# 全部道具：啟用
execute if score all_items value matches 1 run tellraw @s ["","全部道具 ",{"text":"[停用]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/all_items_off"},"hoverEvent":{"action":"show_text","contents":[{"text":"停用後，你將需要購買道具，才可以使用它們；需要 /function 指令使用權限。","color":"red"}]}}," ",{"text":"[啟用]","bold":true,"underlined":true,"color":"green"}]
...
# 隨機事件：停用
execute if score random_event_status value matches 0 run tellraw @s ["","隨機事件 ",{"text":"[停用]","bold":true,"color":"red"}," ",{"text":"[不顯示進度條]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_show_off"},"hoverEvent":{"action":"show_text","contents":[{"text":"啟用隨機事件但不顯示進度條，需要 /function 指令使用權限。","color":"red"}]}}," ",{"text":"[顯示進度條]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_show"},"hoverEvent":{"action":"show_text","contents":[{"text":"啟用隨機事件並顯示進度條，需要 /function 指令使用權限。","color":"red"}]}}]

# 隨機事件：不顯示進度條
execute if score random_event_status value matches 2 run tellraw @s ["","隨機事件 ",{"text":"[停用]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_off"},"hoverEvent":{"action":"show_text","contents":[{"text":"停用隨機事件，需要 /function 指令使用權限。","color":"red"}]}}," ",{"text":"[不顯示進度條]","bold":true,"color":"gold"}," ",{"text":"[顯示進度條]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_show"},"hoverEvent":{"action":"show_text","contents":[{"text":"啟用隨機事件並顯示進度條，需要 /function 指令使用權限。","color":"red"}]}}]

# 隨機事件：顯示進度條
execute if score random_event_status value matches 1 run tellraw @s ["","隨機事件 ",{"text":"[停用]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_off"},"hoverEvent":{"action":"show_text","contents":[{"text":"停用隨機事件，需要 /function 指令使用權限。","color":"red"}]}}," ",{"text":"[不顯示進度條]","color":"gray","clickEvent":{"action":"run_command","value":"/function floorisair:gameplay_settings/random_event_show_off"},"hoverEvent":{"action":"show_text","contents":[{"text":"啟用隨機事件但不顯示進度條，需要 /function 指令使用權限。","color":"red"}]}}," ",{"text":"[顯示進度條]","bold":true,"color":"green"}]
