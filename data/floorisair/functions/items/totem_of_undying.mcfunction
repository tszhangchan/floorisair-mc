...
execute as @a[team=player] at @s if score game_status value matches 1 if score @s Item9_status matches 1 if block ~ ~-1 ~ #floorisair:death_block run tag @s add totem_user
execute as @a[team=player] at @s if score game_status value matches 1 if block ~ ~-1 ~ #floorisair:death_block run tag @s add totem_user
