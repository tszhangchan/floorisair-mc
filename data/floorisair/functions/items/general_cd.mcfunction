...
execute if score game_status value matches 1 if score all_items value matches 0 if score items_cd value matches 1 run item replace entity @a[scores={Item6_status=1,end_crystal_cd=0},team=player] container.5 with minecraft:endermite_spawn_egg{EntityTag:{id:"minecraft:end_crystal"},CanPlaceOn:["#floorisair:floor","#floorisair:dead_block","#floorisair:theme_block"],display:{Name:'{"translate":"floorisair.item.end_crystal","fallback":"End Crystal","italic":false}'},Enchantments:[{}]} 1
execute if score game_status value matches 1 if score all_items value matches 1 if score items_cd value matches 1 run item replace entity @a[scores={end_crystal_cd=0},team=player] container.5 with minecraft:endermite_spawn_egg{EntityTag:{id:"minecraft:end_crystal"},CanPlaceOn:["#floorisair:floor","#floorisair:dead_block","#floorisair:theme_block"],display:{Name:'{"translate":"floorisair.item.end_crystal","fallback":"End Crystal","italic":false}'},Enchantments:[{}]} 1
...
execute if score game_status value matches 1 if score all_items value matches 0 if score items_cd value matches 0 run item replace entity @a[scores={Item6_status=1},team=player] container.5 with minecraft:endermite_spawn_egg{EntityTag:{id:"minecraft:end_crystal"},CanPlaceOn:["#floorisair:floor","#floorisair:dead_block","#floorisair:theme_block"],display:{Name:'{"translate":"floorisair.item.end_crystal","fallback":"End Crystal","italic":false}'},Enchantments:[{}]} 1
execute if score game_status value matches 1 if score all_items value matches 1 if score items_cd value matches 0 run item replace entity @a[team=player] container.5 with minecraft:endermite_spawn_egg{EntityTag:{id:"minecraft:end_crystal"},CanPlaceOn:["#floorisair:floor","#floorisair:dead_block","#floorisair:theme_block"],display:{Name:'{"translate":"floorisair.item.end_crystal","fallback":"End Crystal","italic":false}'},Enchantments:[{}]} 1
