...
execute if score all_items value matches 0 unless score @s Item3_status matches 1 if score @s fiacoin matches ..14 run tellraw @s ["",{"text":"[商店]","color":"gold","bold":true}," 您沒有足夠的 FIA 金幣。"]
