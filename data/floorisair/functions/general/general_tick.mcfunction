...
execute if score game_status value matches 0 run title @a[gamemode=adventure] actionbar ["歡迎來到",{"text":"地板是空氣！","color":"gold","bold":true}]

# 遊戲模式
execute as @a[gamemode=survival] run tellraw @s ["",{"text":"[遊戲]","color":"green","bold":true}," 本遊戲需要使用",{"text":"冒險模式","color":"green","bold":true},"遊玩， 但您正在使用生存模式，已經自動幫您切換，祝您遊戲愉快！"]
...
execute if score game_status value matches 0 if block 0 100 8 minecraft:air run setblock 0 100 8 minecraft:lectern[facing=north,has_book=true,powered=false]{Book:{Count:1b,id:"minecraft:written_book",tag:{author:"command_music",filtered_title:"遊戲鳴謝名單 v1.2",pages:['{"text":"\\n\\n\\n\\n        地板是空氣！\\n       Floor is air!\\n        版本 v1.2\\n\\n\\n     《遊戲鳴謝名單》"}','{"text":"【遊戲作者及開發者】\\n\\n指音\\n  command_music"}','{"text":"【靈感來自】\\n\\nHypixel 派對遊戲"}','{"text":"【協助開發】\\n\\n老章鱼\\n  ZN_zhangyu\\n\\n小小宇\\n  Xiao_Xiao_Yu\\n\\n阿仙\\n  AX_GAME"}','{"text":"【建築】\\n\\n指音\\n  command_music\\n\\n阿仙\\n  AX_GAME"}','{"text":"【建議給予】\\n\\n世界方块\\n  Shi_Jie_Block\\n\\n阿仙\\n  AX_GAME"}','{"text":"【測試】\\n\\n小桃子\\n  ToaDiago\\n\\nwangDiago"}'],resolved:1b,title:"遊戲鳴謝名單 v1.2"}},Page:0}
execute if score game_status value matches 0 if block 0 100 -8 minecraft:air run setblock 0 100 -8 minecraft:lectern[facing=south,has_book=true,powered=false]{Book:{Count:1b,id:"minecraft:written_book",tag:{author:"command_music",filtered_title:"遊戲鳴謝名單 v1.2",pages:['{"text":"\\n\\n\\n\\n        地板是空氣！\\n       Floor is air!\\n        版本 v1.2\\n\\n\\n     《遊戲鳴謝名單》"}','{"text":"【遊戲作者及開發者】\\n\\n指音\\n  command_music"}','{"text":"【靈感來自】\\n\\nHypixel 派對遊戲"}','{"text":"【協助開發】\\n\\n老章鱼\\n  ZN_zhangyu\\n\\n小小宇\\n  Xiao_Xiao_Yu\\n\\n阿仙\\n  AX_GAME"}','{"text":"【建築】\\n\\n指音\\n  command_music\\n\\n阿仙\\n  AX_GAME"}','{"text":"【建議給予】\\n\\n世界方块\\n  Shi_Jie_Block\\n\\n阿仙\\n  AX_GAME"}','{"text":"【測試】\\n\\n小桃子\\n  ToaDiago\\n\\nwangDiago"}'],resolved:1b,title:"遊戲鳴謝名單 v1.2"}},Page:0}
